...
urlpatterns = patterns('',
    ...
    (r'^(?P<safe_topic>\w+)/$', 'blinddata.views.index'),
    (r'^(?P<safe_topic>\w+)/(?P<safe_subtopic>\w+)/$', 'blinddata.views.index'),
    (r'^(?P<safe_topic>\w+)/(?P<safe_subtopic>\w+)/(?P<safe_series>\w+)/$', 'blinddata.views.index'),
